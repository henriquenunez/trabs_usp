...
int main(){
	...
	if (dist < get_circle_radius(a_circle)) printf("O ponto e interior a circunferencia.\nDistancia: %.2f\n", dist);
	else if (dist > get_circle_radius(a_circle)) printf("O ponto e exterior a circunferencia.\nDistancia: %.2f\n", dist);
	else printf("O ponto pertence a circunferencia.\nDistancia: %.2f\n", dist);
